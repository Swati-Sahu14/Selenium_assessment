...
public class day_8 {
	...
	{
		FileInputStream fis = new FileInputStream("./src/test/resources/DDT/day8.properties");
		...
		FileInputStream fis1 = new FileInputStream("./src/test/resources/DDT/TestCase1.xlsx");
