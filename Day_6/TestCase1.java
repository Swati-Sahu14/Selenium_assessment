...
public class TestCase1 {
			public static void main(String[] args) throws IOException, InterruptedException, AWTException {
				...
				//excel
				FileInputStream fis2 = new FileInputStream("./src/test/resources/DDT/day6.xlsx");
...
//				//select userrole to ess
				...
				// Validation
				if(driver.findElement(By.xpath("//div[@class=\"oxd-table-cell oxd-padding-cell\"]/child::div[contains(.,\"Swati23\")]")).isDisplayed()) {
